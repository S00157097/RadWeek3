...
namespace Exercise2.Models
{
    ...
    public partial class SampleDBEntities1 : DbContext
    {
        ...
        [DbFunction("SampleDBEntities1", "ProductsUnderThisUnitPrice")]
        public virtual IQueryable<ProductsUnderThisUnitPrice_Result> ProductsUnderThisUnitPrice(Nullable<decimal> price)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.CreateQuery<ProductsUnderThisUnitPrice_Result>("[SampleDBEntities1].[ProductsUnderThisUnitPrice](@price)", priceParameter);
        }
